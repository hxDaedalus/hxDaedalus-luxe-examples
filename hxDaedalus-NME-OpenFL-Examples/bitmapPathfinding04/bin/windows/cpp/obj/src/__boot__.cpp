...
::hxDaedalus::graphics::Converter_obj::__register();
::hxDaedalus::graphics::_Pixels::PixelsData_obj::__register();
::hxDaedalus::graphics::_Pixels::Pixels_Impl__obj::__register();
::hxDaedalus::graphics::ISimpleDrawingContext_obj::__register();
::hxDaedalus::factories::RectMesh_obj::__register();
::hxDaedalus::factories::BitmapObject_obj::__register();
::hxDaedalus::examples::bitmapPathfinding04::GalapagosColor_obj::__register();
::hxDaedalus::examples::bitmapPathfinding04::GalapagosBW_obj::__register();
::openfl::_v2::display::BitmapData_obj::__register();
::hxDaedalus::debug::Debug_obj::__register();
::hxDaedalus::data::math::ShapeSimplifier_obj::__register();
::hxDaedalus::data::math::RandGenerator_obj::__register();
::hxDaedalus::data::math::Potrace_obj::__register();
::hxDaedalus::data::math::NodeData_obj::__register();
...
::hxDaedalus::data::math::EdgeData_obj::__register();
::hxDaedalus::data::graph::GraphNode_obj::__register();
::hxDaedalus::data::graph::GraphEdge_obj::__register();
::hxDaedalus::data::graph::Graph_obj::__register();
...
::hxDaedalus::ai::trajectory::LinearPathSampler_obj::__register();
::hxDaedalus::ai::PathFinder_obj::__register();
::hxDaedalus::ai::Funnel_obj::__register();
::hxDaedalus::ai::EntityAI_obj::__register();
::hxDaedalus::ai::AStar_obj::__register();
...
::hxDaedalus::examples::bitmapPathfinding04::Main_obj::__register();
...
::hxDaedalus::examples::bitmapPathfinding04::Main_obj::__boot();
...
::hxDaedalus::ai::AStar_obj::__boot();
::hxDaedalus::ai::EntityAI_obj::__boot();
::hxDaedalus::ai::Funnel_obj::__boot();
::hxDaedalus::ai::PathFinder_obj::__boot();
::hxDaedalus::ai::trajectory::LinearPathSampler_obj::__boot();
...
::hxDaedalus::data::graph::Graph_obj::__boot();
::hxDaedalus::data::graph::GraphEdge_obj::__boot();
::hxDaedalus::data::graph::GraphNode_obj::__boot();
::hxDaedalus::data::math::EdgeData_obj::__boot();
...
::hxDaedalus::data::math::NodeData_obj::__boot();
::hxDaedalus::data::math::Potrace_obj::__boot();
::hxDaedalus::data::math::RandGenerator_obj::__boot();
::hxDaedalus::data::math::ShapeSimplifier_obj::__boot();
::hxDaedalus::debug::Debug_obj::__boot();
::openfl::_v2::display::BitmapData_obj::__boot();
::hxDaedalus::examples::bitmapPathfinding04::GalapagosBW_obj::__boot();
::hxDaedalus::examples::bitmapPathfinding04::GalapagosColor_obj::__boot();
::hxDaedalus::factories::BitmapObject_obj::__boot();
::hxDaedalus::factories::RectMesh_obj::__boot();
::hxDaedalus::graphics::ISimpleDrawingContext_obj::__boot();
::hxDaedalus::graphics::_Pixels::Pixels_Impl__obj::__boot();
::hxDaedalus::graphics::_Pixels::PixelsData_obj::__boot();
::hxDaedalus::graphics::Converter_obj::__boot();
