...
class HXCPP_CLASS_ATTRIBUTES  DocumentClass_obj : public ::hxDaedalus::examples::bitmapPathfinding04::Main_obj{
	public:
		typedef ::hxDaedalus::examples::bitmapPathfinding04::Main_obj super;
