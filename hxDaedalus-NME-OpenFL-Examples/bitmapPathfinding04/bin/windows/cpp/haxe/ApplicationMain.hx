...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("JLM", "bitmapPathfinding04", "hxDaedalus.examples.bitmapPathfinding04.bitmapPathfinding04", "1.0.0");
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "bitmapPathfinding04", null, { width: 1024, height: 780 });
			
			
			#if openfl
			var stage = wx.NMEStage.create (frame, null, null, { width: 1024, height: 780 });
			#end
			...
			if (hasMain) {
				...
				var instance = Type.createInstance (hxDaedalus.examples.bitmapPathfinding04.Main, []);
			}
...
import hxDaedalus.examples.bitmapPathfinding04.Main;
