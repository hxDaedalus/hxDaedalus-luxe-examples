...
int color = __o_color.Default(0);
{
	...
	HX_STACK_LINE(28)
	::openfl::_v2::text::TextFormat _g = ::openfl::_v2::text::TextFormat_obj::__new(HX_CSTRING("_sans"),(int)12,color,null(),null(),null(),null(),null(),null(),null(),null(),null(),null());		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(28)
...
Void FPS_obj::this_onEnterFrame( ::openfl::_v2::events::Event event){
{
