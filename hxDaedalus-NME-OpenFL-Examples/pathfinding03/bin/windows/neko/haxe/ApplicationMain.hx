...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("JLM", "pathfinding03", "hxDaedalus.examples.pathfinding03.pathfinding03", "1.0.0");
		...
		flash.Lib.create (function () {
				...
				for (methodName in Type.getClassFields (hxDaedalus.examples.pathfinding03.Main)) {
				...
				if (hasMain) {
					...
					Reflect.callMethod (hxDaedalus.examples.pathfinding03.Main, Reflect.field (hxDaedalus.examples.pathfinding03.Main, "main"), []);
...
@:keep class DocumentClass extends hxDaedalus.examples.pathfinding03.Main {}
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "pathfinding03", null, { width: 600, height: 600 });
			...
			if (hasMain) {
				...
				var instance = Type.createInstance (hxDaedalus.examples.pathfinding03.Main, []);
			}
...
import hxDaedalus.examples.pathfinding03.Main;
