...
HX_DECLARE_CLASS3(hxDaedalus,examples,pathfinding03,Main)
...
class HXCPP_CLASS_ATTRIBUTES  DocumentClass_obj : public ::hxDaedalus::examples::pathfinding03::Main_obj{
	public:
		typedef ::hxDaedalus::examples::pathfinding03::Main_obj super;
