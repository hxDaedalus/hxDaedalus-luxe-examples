...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("JLM", "basic01", "hxDaedalus.examples.basic01.basic01", "1.0.0");
		...
		flash.Lib.create (function () {
				...
				for (methodName in Type.getClassFields (hxDaedalus.examples.basic01.Main)) {
				...
				if (hasMain) {
					...
					Reflect.callMethod (hxDaedalus.examples.basic01.Main, Reflect.field (hxDaedalus.examples.basic01.Main, "main"), []);
...
@:keep class DocumentClass extends hxDaedalus.examples.basic01.Main {}
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "basic01", null, { width: 600, height: 400 });
			...
			if (hasMain) {
				...
				var instance = Type.createInstance (hxDaedalus.examples.basic01.Main, []);
			}
...
import hxDaedalus.examples.basic01.Main;
