...
HX_DECLARE_CLASS3(hxDaedalus,examples,basic01,Main)
...
class HXCPP_CLASS_ATTRIBUTES  DocumentClass_obj : public ::hxDaedalus::examples::basic01::Main_obj{
	public:
		typedef ::hxDaedalus::examples::basic01::Main_obj super;
