...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("JLM", "fromBitmap02", "hxDaedalus.examples.fromBitmap02.fromBitmap02", "1.0.0");
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "fromBitmap02", null, { width: 600, height: 600 });
			...
			if (hasMain) {
				...
				var instance = Type.createInstance (hxDaedalus.examples.fromBitmap02.Main, []);
			}
...
import hxDaedalus.examples.fromBitmap02.Main;
