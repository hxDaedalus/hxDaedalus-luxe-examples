...
HX_DECLARE_CLASS3(hxDaedalus,examples,fromBitmap02,Main)
...
class HXCPP_CLASS_ATTRIBUTES  DocumentClass_obj : public ::hxDaedalus::examples::fromBitmap02::Main_obj{
	public:
		typedef ::hxDaedalus::examples::fromBitmap02::Main_obj super;
